/*
  # Update storage bucket access and policies

  1. Changes
    - Make all storage buckets public
    - Update storage policies to allow public access while preserving upload permissions
    - Handle existing policies safely

  2. Security
    - Maintain authenticated upload restrictions
